        ...
        <main className='py-5'>
            ...
            {Array.isArray(type) && type.length > 0 ? (
                    ...
                    <Table>
                        <TableHeader className='bg-dark-gradient-135deg'>
                            <TableRow>
                                ...
                                <TableHead className="text-color-30 text-center">Name</TableHead>
                                <TableHead className="text-color-30 text-center">Email/ID</TableHead>
                ...
                <div className='flex justify-center py-4'>
                    <p className='text-color-60 text-sm'>No international payment method is uploaded yet!</p>
                </div>
            )}
                        ...
                        render={({ field }) => (
                            <div className='flex flex-col gap-2 w-full mt-5'>
                                ...
                                <FormControl>
                                    <Input
                                        id='type'
                                        placeholder='Payment method e.g Online platform'
                                        type='text'
                                        {...field}
