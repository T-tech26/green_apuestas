    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            if(response === 'success') {
                ...
                await userNotification(games.userId, 'stake', gameDate, '');
    ...
    return (
        <main className='flex-1 pt-14 md:py-14 overflow-x-hidden overflow-y-scroll'>
            <div className='w-4/5 mx-auto flex flex-col gap-5 overflow-x-scroll md:overflow-x-hidden address pb-14 md:pb-0'>
                <h1 className='text-lg text-color-60 font-medium uppercase'>Stake user bets</h1>


                {games.games.length > 0 ? (                    
                    <div className='bg-color-30 rounded-md w-[330px] mx-auto'>
                ...
                <div className='min-w-[330px] my-5'>
                    <Form {...form}>
                        <form>
